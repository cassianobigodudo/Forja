...
function LandingPage() {
  ...
  const [abrirBox, setAbrirBox] = useState(false)
    ...
    <>
      ...
      <div className="container-landing-page-cima"  ref={sectionAltoRef}>
        ...
        <div className="container-centro">
          ...
          <button className='btn-entrar' onClick={() => setAbrirBox(true)}>ENTRAR</button>
        </div>
        ...
        <dialog className='dialog-login-cadastro' open={abrirBox}>
          <div className="container-dialog-log">
